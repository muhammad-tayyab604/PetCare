  ...
  <style>
    ...
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        ...
        <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4">
                <a href="#" class="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark-mode dark:text-white focus:outline-none focus:shadow-outline">Admin Permissions</a>
      ...
      <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
        <div class="overflow-hidden">
          ...
          <h2>Edit</h2>
            ...
            <a href="{{route ('admin.permissions.edit')}}"><button type="submit" class="button button2">Edit</button></a>
